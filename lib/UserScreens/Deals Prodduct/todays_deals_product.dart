...
class TodaysDealsProducts extends StatefulWidget {
  const TodaysDealsProducts({super.key});

  @override
  State<TodaysDealsProducts> createState() => _TodaysDealsProductsState();
}

class _TodaysDealsProductsState extends State<TodaysDealsProducts> {
  @override
